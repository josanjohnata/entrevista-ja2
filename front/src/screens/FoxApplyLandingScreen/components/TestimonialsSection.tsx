...
const testimonials = [
  {
    ...
    content: "Estava há 6 meses sem receber nenhum retorno. Com o Entrevista Já, apliquei para mais de 200 vagas e recebi 8 convites para entrevistas em apenas 2 semanas! Consegui minha primeira vaga.",
    avatar: "AC",
  },
  {
    name: "Pedro Silva",
    ...
    content: "Não acreditava que funcionaria, mas na primeira semana já recebi 5 convites para entrevistas! O Entrevista Já multiplicou minhas chances de ser visto pelos recrutadores.",
    avatar: "PS",
  },
  {
    name: "Mariana Santos",
    ...
    content: "Sai da faculdade sem experiência e estava desanimada. Usei o Entrevista Já por 1 mês, apliquei para 300+ vagas e recebi 12 convites! Hoje estou empregada.",
    avatar: "MS",
  },
  {
    name: "João Oliveira",
    ...
    content: "Depois de meses sem resposta, usei o Entrevista Já e em apenas 3 dias recebi meu primeiro convite para entrevista! A sensação de finalmente ser chamado é indescritível.",
    avatar: "JO",
  },
  {
    name: "Lucas Mendes",
    ...
    content: "Em 2 semanas usando o Entrevista Já, recebi 5 convites para entrevistas. Consegui uma vaga remota pagando em dólar. Mudou minha vida!",
    avatar: "LM",
  },
  {
    ...
    content: "Estava há 8 meses procurando minha primeira vaga. Com o Entrevista Já, consegui 6 entrevistas ao mesmo tempo! Finalmente consegui escolher a melhor proposta.",
    avatar: "CF",
  },
  {
    name: "Gabriel Alves",
    ...
    content: "Aplicava manualmente e nunca recebia retorno. Com o Entrevista Já, apliquei para centenas de vagas e recebi 10 convites! A diferença é absurda.",
    avatar: "GA",
  },
  {
    name: "Isabella Costa",
    ...
    content: "Transição de carreira é difícil, mas o Entrevista Já me ajudou a receber várias entrevistas rapidamente. Em 20 dias já estava empregada na área que sempre sonhei!",
    avatar: "IC",
  },
  {
    name: "James Wilson",
    ...
    content: "I was struggling to get any responses for months. With Entrevista Já, I applied to 250+ jobs and got 7 interview invitations in just 2 weeks! Finally landed my first tech job.",
    avatar: "JW",
  },
  {
    name: "Sarah Chen",
    ...
    content: "As a career changer, I was worried about my lack of experience. Entrevista Já helped me get 10 interviews in my first month! The automated applications saved me so much time.",
    avatar: "SC",
  },
  {
    ...
    content: "I wanted to work remotely for a US company. Entrevista Já applied to hundreds of international positions and I got multiple interviews. Now I'm working remotely earning in dollars!",
    avatar: "MR",
  },
];
